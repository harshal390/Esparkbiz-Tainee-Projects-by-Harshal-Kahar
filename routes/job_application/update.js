...
const { fetch_data, object_to_transpose_2d_array, update_into_basic_details, update_into_education_details } = require("../../controllers/job_application");

route.get("/job_application/update/:id", async (req, res) => {
    res.render('job_application/index.ejs');
}).put("/job_application/update/:id", async (req, res) => {
