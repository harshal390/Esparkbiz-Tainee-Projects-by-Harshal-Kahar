...
const app = express();
const port = 3000;
const { home, dynamic_table, kuku_cube, tic_tac_toe, static_websites, pagination, attendence_master, searching_by_query, searching_by_multiple_field, delimeter_search, registration,login,logout } = require("./routes/index")
...
const job_application_index = require("./routes/job_application/index");
const job_application_update = require("./routes/job_application/update");
